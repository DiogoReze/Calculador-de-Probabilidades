...
class JanelaResultado(tk.Tk):
    def __init__(self):
        ...
        self.title("Resultados de Previsão")
        self.geometry("400x200")

        self.label_acuracia = tk.Label(self, text="Acurácia: ", anchor="w", font=fonte)
        self.label_acuracia.pack()

        self.label_previBaixa = tk.Label(self, text="Probabilidade de Baixa: ", anchor="w", font=fonte)
        self.label_previBaixa.pack()

        self.label_previDoji = tk.Label(self, text="Probabilidade de Doji: ", anchor="w", font=fonte)
        self.label_previDoji.pack()

        self.label_previAlta = tk.Label(self, text="Probabilidade de Alta: ", anchor="w", font=fonte)
    ...
    def atualizar_resultados(self, acuracia, previBaixa, previDoji, previAlta):
        ...
        self.label_previBaixa.config(text=f"Probabilidade de Baixa: {previBaixa:.2f}%", anchor="w", font=fonte)
        self.label_previDoji.config(text=f"Probabilidade de Doji: {previDoji:.2f}%", anchor="w", font=fonte)
        self.label_previAlta.config(text=f"Probabilidade de Alta: {previAlta:.2f}%", anchor="w", font=fonte)
